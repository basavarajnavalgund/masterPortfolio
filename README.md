...
To view a live example, **[click here](https://basavarajnavalgund.github.io/)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  - ```python
     git clone https://github.com/basavarajnavalgund/masterPortfolio.git
    ```
...
In this project, there are basically 3 things that you need to change to customize this to anyone else's portfolio: **package.json**, **Personal Information**, **Github Information**.
